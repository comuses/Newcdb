...
namespace App\Filament\Resources\Case1Resource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('case1.partyID')->limit(50),
            ])
            ->filters([
                ...
                MultiSelectFilter::make('case1_id')->relationship(
                    'case1',
                    'partyID'
                ),
            ])
