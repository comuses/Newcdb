                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        @can('update', $retain)
                                        <a
                                            href="{{ route('retains.edit', $retain) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $retain)
                                        <a
                                            href="{{ route('retains.show', $retain) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $retain)
                                        <form
                                            action="{{ route('retains.destroy', $retain) }}"
                                            method="POST"
