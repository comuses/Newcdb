                ...
                <div class="mt-4 px-4">
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.bars.inputs.attorneyID')
                        </h5>
                        <span>{{ $bar->attorneyID ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.bars.inputs.bar')
                        </h5>
                        <span>{{ $bar->bar ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.bars.inputs.attorney_id')
                        </h5>
                        <span>{{ optional($bar->attorney)->name ?? '-' }}</span>
                    </div>
                </div>
