        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Case1::class)
                        <x-dropdown-link href="{{ route('case1s.index') }}">
                        Case1s
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Party::class)
                        ...
                        @endcan
                        @can('view-any', App\Models\Speciality::class)
                        <x-dropdown-link href="{{ route('specialities.index') }}">
                        Specialities
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Retain::class)
                        <x-dropdown-link href="{{ route('retains.index') }}">
                        Retains
                        </x-dropdown-link>
                        @endcan
                </x-nav-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Case1::class)
                <x-responsive-nav-link href="{{ route('case1s.index') }}">
                Case1s
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Party::class)
                <x-responsive-nav-link href="{{ route('parties.index') }}">
                Parties
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Court::class)
                ...
                @endcan
                @can('view-any', App\Models\Speciality::class)
                <x-responsive-nav-link href="{{ route('specialities.index') }}">
                Specialities
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Judge::class)
                ...
                @endcan
                @can('view-any', App\Models\Retain::class)
                <x-responsive-nav-link href="{{ route('retains.index') }}">
                Retains
                </x-responsive-nav-link>
                @endcan
